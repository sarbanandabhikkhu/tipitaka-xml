...
const webFXTreeConfig = {
  ic_i: `${icons_dir}icons/xtree/i.svg`,
  ic_l: `${icons_dir}icons/xtree/l.svg`,
  ic_t: `${icons_dir}icons/xtree/t.svg`,
  ic_lplus: `${icons_dir}icons/xtree/l-plus.svg`,
  ic_tplus: `${icons_dir}icons/xtree/t-plus.svg`,
  ic_lminus: `${icons_dir}icons/xtree/l-minus.svg`,
  ic_tminus: `${icons_dir}icons/xtree/t-minus.svg`,
  ic_blank: `${icons_dir}icons/xtree/blank.svg`,
  ic_file: `${icons_dir}icons/default/bold/file-text.svg`,
  ic_folder: `${icons_dir}icons/default/bold/folder.svg`,
  ic_openfolder: `${icons_dir}icons/default/bold/folder-open.svg`,
...
function WebFXTree(e, t, o, i, n) {
  ...
  this.rendered = !1;
  this.onSelect = null;
  webFXTreeHandler.behavior || (webFXTreeHandler.behavior = o || webFXTreeConfig.defaultBehavior);
}
...
function WebFXLoadTree(e, t, o, i, n, r) {
  ...
  this.open
    ...
    : ((this._loadingItem = new WebFXTreeItem(webFXTreeConfig.loadingText)), this.add(this._loadingItem));
}
...
function _xmlTreeToJsTree(e) {
  let o = e.getAttribute("text"),
    ...
    c = l.length,
    h = 0,
    t = m ? new WebFXLoadTreeItem(o, s, i, null, n, r) : new WebFXTreeItem(o, i, null, n, r);
  "" !== d && (t.target = d);
  for (l, c, h; h < c; h++) "tree" === l[h].tagName && t.add(_xmlTreeToJsTree(l[h]), !0);
  return t;
}
  ...
  if (!t.loaded) {
    ...
    if (((t.loaded = !0), (t.loading = !1), l)) {
      ...
      let n = e.documentElement.childNodes,
        r = n.length,
        s = 0;
      for (n, r, s; s < r; s++) "tree" === n[s].tagName && ((i = !0), (o = !0), t.add(_xmlTreeToJsTree(n[s]), !0));
...
function getDomDocumentPrefix() {
  ...
  for (e, t = 0; t < e.length; t++)
    try {
      return new ActiveXObject(e[t] + ".DomDocument"), (getDomDocumentPrefix.prefix = e[t]);
    } catch (e) {}
...
function getXmlHttpPrefix() {
  ...
  for (e, t = 0; t < e.length; t++)
    try {
      return new ActiveXObject(e[t] + ".XmlHttp"), (getXmlHttpPrefix.prefix = e[t]);
    } catch (e) {}
  throw new Error("Could not find an installed XML parser");
}
...
WebFXCookie.prototype.getCookie = function (e) {
  if (this.cookies) {
    ...
    return unescape(i.substr(i.indexOf("=") + 1, i.length - i.indexOf("=") + 1));
  }
  return null;
};
...
WebFXTreeAbstractNode.prototype.add = function (e, t) {
  ...
  if (o.rendered) {
    ...
    cn.length >= 2 &&
      ((document.getElementById(cn[cn.length - 2].id + "-plus").src = cn[cn.length - 2].folder
        ? cn[cn.length - 2].open
          ? ic_tminus
          : ic_tplus
        : ic_t),
    ...
    webFXTreeHandler.insertHTMLBeforeEnd(document.getElementById(this.id + "-cont"), e.toString());
    this.folder || this.openIcon || ((this.icon = ic_folder), (this.openIcon = ic_openfolder)),
...
WebFXTreeAbstractNode.prototype.deSelect = function () {
  (document.getElementById(this.id + "-anchor").className = ""), (webFXTreeHandler.selected = null);
};

WebFXTreeAbstractNode.prototype.focus = function () {
  webFXTreeHandler.selected && webFXTreeHandler.selected != this && webFXTreeHandler.selected.deSelect(),
...
WebFXTreeAbstractNode.prototype.doExpand = function () {
  "classic" == webFXTreeHandler.behavior && (document.getElementById(this.id + "-icon").src = this.openIcon),
    this.childNodes.length && (document.getElementById(this.id + "-cont").style.display = "block"),
    (this.open = !0),
    webFXTreeConfig.usePersistence && webFXTreeHandler.cookies.setCookie(this.id.substr(18, this.id.length - 18), "1");
};

WebFXTreeAbstractNode.prototype.doCollapse = function () {
  "classic" == webFXTreeHandler.behavior && (document.getElementById(this.id + "-icon").src = this.icon),
    this.childNodes.length && (document.getElementById(this.id + "-cont").style.display = "none"),
    (this.open = !1),
    webFXTreeConfig.usePersistence && webFXTreeHandler.cookies.setCookie(this.id.substr(18, this.id.length - 18), "0");
};
...
WebFXTreeAbstractNode.prototype.expandChildren = function () {
  for (let e = 0; e < this.childNodes.length; e++) this.childNodes[e].expandAll();
};
...
WebFXTreeAbstractNode.prototype.collapseChildren = function () {
  for (let e = 0; e < this.childNodes.length; e++) this.childNodes[e].collapseAll();
};

WebFXTreeAbstractNode.prototype.indent = function (e, t, o, i, n) {
  null == e && (e = -2);
  for (let r = this.childNodes.length - 1; r >= 0; r--) if (this.childNodes[r].indent(e + 1, t, o, i)) return;
  if (t && i >= this._level && document.getElementById(this.id + "-plus"))
    return (
      this.folder
        ...
        : n && (document.getElementById(this.id + "-plus").src = webFXTreeConfig.ic_l),
      1
    );
  const s = document.getElementById(this.id + "-indent-" + e);
  return s && (s._last || (t && o) ? (s.src = webFXTreeConfig.ic_blank) : (s.src = webFXTreeConfig.ic_i)), 0;
};
...
WebFXTree.prototype.keydown = function (e) {
  return 39 == e
    ? (this.open ? this.childNodes.length && this.childNodes[0].select() : this.expand(), !1)
    : 37 == e
    ? (this.collapse(), !1)
    : 40 != e || !this.open || !this.childNodes.length || (this.childNodes[0].select(), !1);
};
...
WebFXTree.prototype.toString = function () {
  for (
    var e = `<div id="${
        ...
        "classic" == webFXTreeHandler.behavior && this.open ? this.openIcon : this.icon
...
WebFXTreeItem.prototype.remove = function () {
  var e = document.getElementById(this.id + "-plus").src,
    ...
    n = (this.parentNode.folder, !i || !i.parentNode || i.parentNode.id != t.id);
  this.getPreviousSibling().focus(),
    ...
    o != t ||
      ...
      ((o.folder = !1),
      (o.open = !1),
      (e = (e = document.getElementById(o.id + "-plus").src).replace("minus", "").replace("plus", "")),
    ...
    document.getElementById(o.id + "-plus") &&
      t == o.parentNode &&
      ((e = e.replace("minus", "").replace("plus", "")), (document.getElementById(o.id + "-plus").src = e));
};

WebFXTreeItem.prototype._remove = function () {
  for (var e = this.childNodes.length - 1; e >= 0; e--) this.childNodes[e]._remove();
  for (e = 0; e < this.parentNode.childNodes.length; e++)
    if (this == this.parentNode.childNodes[e]) {
      ...
      (this.parentNode.childNodes.length -= 1),
        e + 1 == this.parentNode.childNodes.length && (this.parentNode._last = !0);
      break;
    }
  webFXTreeHandler.all[this.id] = null;
  var o = document.getElementById(this.id);
  o && o.parentNode.removeChild(o), (o = document.getElementById(this.id + "-cont")) && o.parentNode.removeChild(o);
};

WebFXTreeItem.prototype.expand = function () {
  this.doExpand(), (document.getElementById(this.id + "-plus").src = this.minusIcon);
};

WebFXTreeItem.prototype.collapse = function (e) {
  e || this.focus(), this.doCollapse(), (document.getElementById(this.id + "-plus").src = this.plusIcon);
};
...
WebFXTreeItem.prototype.getNextSibling = function () {
  for (var e = 0; e < this.parentNode.childNodes.length && this != this.parentNode.childNodes[e]; e++);
  return ++e == this.parentNode.childNodes.length ? this.parentNode.getNextSibling() : this.parentNode.childNodes[e];
};

WebFXTreeItem.prototype.getPreviousSibling = function (e) {
  for (var t = 0; t < this.parentNode.childNodes.length && this != this.parentNode.childNodes[t]; t++);
  return 0 == t
    ? this.parentNode
    : this.parentNode.childNodes[--t].open || (e && this.parentNode.childNodes[t].folder)
    ? this.parentNode.childNodes[t].getLast()
    : this.parentNode.childNodes[t];
};

WebFXTreeItem.prototype.keydown = function (e) {
  if (39 == e && this.folder) return this.open ? this.getFirst().select() : this.expand(), !1;
  if (37 == e) return this.open ? this.collapse() : this.parentNode.select(), !1;
  if (40 == e) {
...
WebFXTreeItem.prototype.toString = function (e, t) {
  ...
  for (var n = 0; o.parentNode; )
    (o = o.parentNode),
      (i = `<img id="${this.id}-indent-${n}" src="${o._last ? webFXTreeConfig.ic_blank : webFXTreeConfig.ic_i}">` + i),
      n++;
  (this._level = n),
  ...
  var r = this.text.replace(/</g, "&lt;").replace(/>/g, "&gt;"),
    ...
    }" onclick="webFXTreeHandler.toggle(this)"><img id="${this.id}-icon" class="webfx-tree-icon" src="${
      "classic" == webFXTreeHandler.behavior && this.open ? this.openIcon : this.icon
    }" onclick="webFXTreeHandler.select(this)"><a href="${this.action}" id="${
      this.id
    }-anchor" onfocus="webFXTreeHandler.focus(this)" onblur="webFXTreeHandler.blur(this)"${
      this.target ? ` target="${this.target}"` : ""
    }>${r}</a></div><div id="${this.id}-cont" class="webfx-tree-container" style="display:${
      this.open ? "block" : "none"
    }">`,
    d = [];
  for (n = 0; n < this.childNodes.length; n++) d[n] = this.childNodes[n].toString(n, this.childNodes.length);
  return (
    (this.plusIcon = this.parentNode._last ? webFXTreeConfig.ic_lplus : webFXTreeConfig.ic_tplus),
    (this.minusIcon = this.parentNode._last ? webFXTreeConfig.ic_lminus : webFXTreeConfig.ic_tminus),
    s + d.join("") + "</div>"
  );
};
...
WebFXLoadTree.prototype.expand = function () {
  this.loaded || this.loading || _startLoadXmlTree(this.src, this), this._webfxtree_expand();
};
...
WebFXLoadTreeItem.prototype.expand = function () {
  this.loaded || this.loading || _startLoadXmlTree(this.src, this), this._webfxtreeitem_expand();
};

WebFXLoadTree.prototype.reload = WebFXLoadTreeItem.prototype.reload = function () {
  if (this.loaded) {
    for (var e = this.open; this.childNodes.length > 0; ) this.childNodes[this.childNodes.length - 1].remove();
    (this.loaded = !1),
      ...
      return (
        null == e.readyState &&
          ...
          e.addEventListener(
            "load",
            function () {
              (e.readyState = 4), "function" == typeof e.onreadystatechange && e.onreadystatechange();
            },
            !1
          )),
        e
...
window.DOMParser &&
  ...
  ((XMLDocument.prototype.loadXML = Document.prototype.loadXML =
    function (e) {
      for (var t = new DOMParser().parseFromString(e, "text/xml"); this.hasChildNodes(); )
        this.removeChild(this.lastChild);
      for (var o = 0; o < t.childNodes.length; o++) this.appendChild(this.importNode(t.childNodes[o], !0));
    }),
